...
int main()
{
    ...
    for (int test_num = 36; test_num < num_of_tests + 1; test_num++) {
        char path[1000];
        sprintf(path, R"(C:\Users\hilla\CLionProjects\MTM_HW2\example_tests\in\input%d.in)", test_num);
...
//        cout << "Finished and Quitting test no. " << test_num << endl;
        // Quit
        delete obj;
    }
	return 0;
